...
## Installation
Make sure you have cowsay installed (If using [Homebrew](https://brew.sh/), type `brew install cowsay`), and put melville.cow in your cows folder (which you can find with `cowsay -l`). Then, put the seababble file somewhere you can access and two lines like this in your .zshrc:
```
